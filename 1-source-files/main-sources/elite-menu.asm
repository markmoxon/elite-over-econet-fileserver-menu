...
\       Type: Variable
\   Category: Server menu
\    Summary: The z_hi ship distance for each menu item
\
\ ******************************************************************************
...
.TITLE
 ...
 LDA shipDistance       \ Set z_lo = shipDistance, so the closest the ship gets
 STA INWK+6             \ to us is z_hi = 1, z_lo = shipDistance
...
.TLL2
 ...
 LDA INWK+7             \ If z_hi (the ship's distance) is shipDistanceHi, jump
 CMP shipDistance+1     \ to TL1 to skip the following decrement
 BEQ TL1
